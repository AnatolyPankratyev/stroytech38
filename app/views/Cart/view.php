            ...
            <div class="col-md-12">
                <div class="product-one cart">
                    <div class="register-top heading">
                        <h2 class="cart_h">Оформление заказа</h2>
                    </div>
                    <br><br>
                            ...
                            <form method="post" action="cart/checkout" role="form" data-toggle="validator">
                                <?php if(!isset($_SESSION['user'])): ?>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" name="tel" class="form-control" id="tel" placeholder="Телефон" value="<?= isset($_SESSION['form_data']['tel']) ? $_SESSION['form_data']['tel'] : '' ?>" required>
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    </div>
                                    <div class="form-group has-feedback">
                                ...
                                <div class="form-group">
                                    <label for="address">Комментарии к заказу</label>
